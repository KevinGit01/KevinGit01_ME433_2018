...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            float iir = 0;
            if(myIndex >= 2){
             maf = (myData[myIndex-2] + myData[myIndex-1] +myData[myIndex])/3.0;  
            }
            ...
            if(myIndex < 1){
                ...
                iir = 0.5*myData[myIndex] + 0.5*iirOld[myIndex-1];
                iirOld[myIndex] = iir;
            }
            if(myIndex >= 5){
             fir = 0.0264*myData[myIndex - 5] + 0.1405*myData[myIndex-4] + 0.3331*myData[myIndex-3] + 0.3331*myData[myIndex-2] + 0.1405*myData[myIndex-1] + 0.0264*myData[myIndex];  
            }
            ...
            if (appData.readBuffer[0] == 0x72)
            {
              ...
              len = sprintf(dataOut, "%3d   %3.3f   %3.3f  %3.3f %3.3f\r\n", i, myData[myIndex],maf,fir,iir);
